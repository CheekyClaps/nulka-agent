...
CONFIG_PATH = os.path.expanduser("~/.omnihub_env")
...
# Global state to support the /teach feedback loop
...
def run_onboarding_wizard():
    ...
    banner = (
        "[bold cyan]========================================================================[/bold cyan]\n"
        "                 [bold yellow]🌟 Welcome to OmniHub Onboarding! 🌟[/bold yellow]\n"
    ...
    try:
        with open(CONFIG_PATH, "w") as f:
            f.write("# OmniHub Environment Configuration\n")
...
def run_interactive_cli():
    ...
    console.print(Panel(welcome_text, title="[bold green]OmniHub[/]", border_style="green"))
    
    from prompt_toolkit.history import FileHistory
    import os
    history_file = os.path.join(os.path.expanduser("~"), ".omnihub_history")
