...
CONFIG_PATH = os.path.expanduser("~/.omniagentcore_env")
...
from omniagentcore.utils import (
    instantiate_agents, 
    get_system_context, 
    ollama_llm,
    is_ollama_running,
...
from omniagentcore.hrf_manager import HRFManager
...
def execute_teach_feedback():
    ...
    from omniagentcore.tools.oracle_cli_tool import OracleCLITool
    from omniagentcore.tools.interactive_teacher_tool import InteractiveTeacherTool
...
def run_onboarding_wizard():
    ...
    banner = (
        "[bold cyan]========================================================================[/bold cyan]\n"
        "                 [bold yellow]🌟 Welcome to OmniAgentCore Onboarding! 🌟[/bold yellow]\n"
    ...
    try:
        with open(CONFIG_PATH, "w") as f:
            f.write("# OmniAgentCore Environment Configuration\n")
...
def run_interactive_cli():
    ...
    console.print(Panel(welcome_text, title="[bold green]OmniAgentCore[/]", border_style="green"))
    
    from prompt_toolkit.history import FileHistory
    import os
    history_file = os.path.join(os.path.expanduser("~"), ".omniagentcore_history")
    ...
    while True:
        ...
        if user_input.lower() in ['/quit', 'exit', 'quit']:
            console.print("[bold yellow]Powering down OmniAgentCore. Goodbye human[/]")
            break
